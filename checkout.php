...
if(isset($_POST['submit'])){
	...
	if($payment_type=='instamojo'){
		...
		curl_setopt($ch, CURLOPT_HTTPHEADER,
			array("X-Api-Key:b1dce34a82d8c0eaf91e3ac52425c055","X-Auth-Token:f11ed771e07746692fa4198119b58eab")
		);
                                                ...
                                                <div class="col-md-6">
                                                    <div class="checkout-method__login">
                                                        <form id="login-form" method="post">
                                                            ...
                                                            <div class="dark-btn">
                                                                <button type="button" class="btn btn-outline-primary-2" onclick="user_login()">Login</button>
                                                            </div>
										...
										<div class="accordion__body">
											<div class="paymentinfo">
												<div class="single-method">
													...
													&nbsp;&nbsp;prepaid <input type="radio" name="payment_type" value="instamojo" required/>
												</div>
												<div class="single-method">
...
$qty=$val1['qty'];	
							...
							<div class="ordre-details__total bilinfo">
                                <input placeholder="Enter Coupon here"  type="textbox" id="coupon_str" class="coupon_style mr5"/> <input type="button" name="submit" class="btn btn-outline-primary-2 coupon_style" value="Apply Coupon" onclick="set_coupon()"/>
