							    ...
							    <div class="tab-pane fade show active" id="register-2" role="tabpanel" aria-labelledby="register-tab-2">
									<form id="login-form" method="post">
							    		...
							    		<div class="form-footer">
											<button  class="btn btn-outline-primary-2" onclick="user_login()">Login</button>
									...
									<div class="form-output login_msg">
										...
										First time user Then Register from here...
									<a href="register.php" class="btn btn-outline-primary-2">Register</a>
								</div>
							</div>
						</div>	   	
            		</div><!-- End .form-box -->
