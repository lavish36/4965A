                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="product-details">
									...
									<a class="btn btn-outline-primary-2" href="javascript:void(0)" onclick="manage_cart('<?php echo $get_product['0']['id']?>','add')">Add to cart</a>
									
                                    <a class="btn btn-outline-primary-2 buy_now" href="javascript:void(0)" onclick="manage_cart('<?php echo $get_product['0']['id']?>','add','yes')">Buy Now</a>
